                    ...
                    <div class="setting-field">
                        ...
                        <div class="field-control c-upload-image">
                            <?php
                                ...
                                if($default_og_image_url) {
                            ?>
                                <img class="upload-image__preview" src="<?=$default_og_image_url?>" />
                            <?php
                                }
                            ?>
                    ...
                    <div class="setting-field">
                        ...
                        <div class="field-control">
                            ...
                            <?php
                                ...
                                if($default_twitter_image_url) {
                            ?>
                                <img class="upload-image__preview" src="<?=$default_twitter_image_url?>" />
                            <?php
                                }
                            ?>
