...
namespace BoldMinded\DataGrab\Dependency\Termwind\ValueObjects;

use Closure;
use BoldMinded\DataGrab\Dependency\Termwind\Actions\StyleToMethod;
use BoldMinded\DataGrab\Dependency\Termwind\Components\Element;
use BoldMinded\DataGrab\Dependency\Termwind\Components\Hr;
use BoldMinded\DataGrab\Dependency\Termwind\Components\Li;
use BoldMinded\DataGrab\Dependency\Termwind\Components\Ol;
use BoldMinded\DataGrab\Dependency\Termwind\Components\Ul;
use BoldMinded\DataGrab\Dependency\Termwind\Enums\Color;
use BoldMinded\DataGrab\Dependency\Termwind\Exceptions\ColorNotFound;
use BoldMinded\DataGrab\Dependency\Termwind\Exceptions\InvalidStyle;
use BoldMinded\DataGrab\Dependency\Termwind\Repositories\Styles as StyleRepository;
use function BoldMinded\DataGrab\Dependency\Termwind\terminal;
/**
 * @internal
 */
final class Styles
{
     ...
     */
    public final function __construct(private array $properties = ['colors' => [], 'options' => [], 'isFirstChild' => \false], private array $textModifiers = [], private array $styleModifiers = [], private array $defaultStyles = [])
    {
    }
    /**
     * @return $this
    ...
    {
        $this->styleModifiers[__METHOD__] = static fn($text): string => \sprintf("\x1b[1m%s\x1b[0m", $text);
        return $this;
    }
    /**
    ...
    {
        $this->styleModifiers[__METHOD__] = static fn($text): string => \sprintf("\x1b[3m%s\x1b[0m", $text);
        return $this;
    }
    /**
    ...
    {
        $this->styleModifiers[__METHOD__] = static fn($text): string => \sprintf("\x1b[4m%s\x1b[0m", $text);
        return $this;
    }
    /**
     ...
     */
    public final function pl(int $padding) : static
    {
     ...
     */
    public final function pr(int $padding) : static
    {
     ...
     */
    public final function pt(int $padding) : static
    {
     ...
     */
    public final function pb(int $padding) : static
    {
     ...
     */
    public final function w(int|string $width) : static
    {
     ...
     */
    public final function wFull() : static
    {
        return $this->w('1/1');
    }
    /**
     ...
     */
    public final function wAuto() : static
    {
     ...
     */
    public final function minW(int|string $width) : static
    {
     ...
     */
    public final function maxW(int|string $width) : static
    {
    ...
    {
        $this->textModifiers[__METHOD__] = static fn($text): string => \mb_strtolower((string) \preg_replace(['/([a-z\\d])([A-Z])/', '/([^_])([A-Z][a-z])/'], '$1_$2', $text), 'UTF-8');
        return $this;
    }
    /**
    ...
    {
        $this->styleModifiers[__METHOD__] = static fn($text): string => \sprintf("\x1b[9m%s\x1b[0m", $text);
        return $this;
    }
    /**
    ...
    {
        $this->styleModifiers[__METHOD__] = static fn($text): string => \sprintf("\x1b[8m%s\x1b[0m", $text);
        return $this;
    }
    /**
    ...
    public final function list(string $type, int $index = 0) : self
    {
        if (!$this->element instanceof Ul && !$this->element instanceof Ol && !$this->element instanceof Li) {
            throw new InvalidStyle(\sprintf('Style list-none cannot be used with %s', $this->element !== null ? $this->element::class : 'unknown element'));
        }
    ...
    private function getFormatString() : string
    {
        ...
        if ($options !== []) {
            $options = \array_keys(\array_filter($options, fn($option) => $option === \true));
    ...
    {
        return \mb_strwidth(\preg_replace(self::STYLING_REGEX, '', $text ?? $this->element?->toString() ?? '') ?? '', 'UTF-8');
    }
    /**
