...
final class InheritStyles
{
    ...
    private function applyFlex(array $elements) : array
    {
        ...
        $flexed = \array_values(\array_filter($elements, fn($element) => $element->hasStyle('flex-1')));
    ...
    private function applyJustifyAround(array $elements) : array
    {
        ...
        return [\str_repeat(' ', (int) \floor(($parentWidth - $contentSize) / 2)), ...$arr, \str_repeat(' ', (int) \ceil(($parentWidth - $contentSize) / 2))];
    }
    /**
