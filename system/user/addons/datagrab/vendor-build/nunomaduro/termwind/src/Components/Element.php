...
namespace BoldMinded\DataGrab\Dependency\Termwind\Components;
...
use BoldMinded\DataGrab\Dependency\Termwind\Html\InheritStyles;
...
abstract class Element
{
     ...
     */
    public final function __construct(protected OutputInterface $output, protected array|string $content, ?Styles $styles = null)
    {
     ...
     */
    public static final function fromStyles(OutputInterface $output, array|string $content, string $styles = '', array $properties = []) : static
    {
     ...
     * @param  array<int, Element|string>|string  $content
     */
    public final function setContent(array|string $content) : static
    {
