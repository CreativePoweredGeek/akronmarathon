...
use DOMDocument;
use DOMNode;
use BoldMinded\DataGrab\Dependency\Termwind\Html\CodeRenderer;
use BoldMinded\DataGrab\Dependency\Termwind\Html\PreRenderer;
use BoldMinded\DataGrab\Dependency\Termwind\Html\TableRenderer;
...
final class HtmlRenderer
{
    ...
    public function parse(string $html) : Components\Element
    {
        ...
        $html = '<?xml encoding="UTF-8"><!DOCTYPE html><html><body>' . \trim($html) . '</body></html>';
