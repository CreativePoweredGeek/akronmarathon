...
use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Terminal as SymfonyTerminal;
class Terminal
{
    /**
    ...
    {
        (new ReflectionClass($this->terminal))->getMethod('initDimensions')->invoke($this->terminal);
    }
    /**
    ...
    protected function exec(string $command) : string
    {
        ...
        if ($code !== 0 || $stdout === \false) {
            throw new RuntimeException(\trim($stderr ?: "Unknown error (code: {$code})"), $code);
        }
        return $stdout;
    }
}
