...
namespace BoldMinded\DataGrab\Dependency\Laravel\Prompts\Themes\Default\Concerns;
...
trait DrawsBoxes
{
     ...
     * @return $this
     */
    protected function box(string $title, string $body, string $footer = '', string $color = 'gray', string $info = '') : self
    {
