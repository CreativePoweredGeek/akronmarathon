...
use BoldMinded\DataGrab\Dependency\Laravel\Prompts\Output\ConsoleOutput;
use BoldMinded\DataGrab\Dependency\Laravel\Prompts\Support\Result;
...
abstract class Prompt
{
    ...
    {
        $this->newLinesWritten = \method_exists(static::output(), 'newLinesWritten') ? static::output()->newLinesWritten() : 1;
    }
    /**
