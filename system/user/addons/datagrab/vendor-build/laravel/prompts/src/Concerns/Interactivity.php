...
use BoldMinded\DataGrab\Dependency\Laravel\Prompts\Exceptions\NonInteractiveValidationException;
trait Interactivity
{
    /**
     ...
     */
    public static function interactive(bool $interactive = \true) : void
    {
