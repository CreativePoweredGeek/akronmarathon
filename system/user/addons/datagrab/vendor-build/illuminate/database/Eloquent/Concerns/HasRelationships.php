...
use Closure;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\ClassMorphViolationException;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\PendingHasThroughRelationship;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\HasMany;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\HasOne;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\MorphMany;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\MorphOne;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\MorphTo;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
    ...
    protected function morphInstanceTo($target, $name, $type, $id, $ownerKey)
    {
        ...
        return $this->newMorphTo($instance->newQuery(), $this, $id, $ownerKey ?? $instance->getKeyName(), $type, $name);
    }
    /**
    ...
    public function hasMany($related, $foreignKey = null, $localKey = null)
    {
        ...
        $foreignKey = $foreignKey ?: $this->getForeignKey();
        $localKey = $localKey ?: $this->getKeyName();
        return $this->newHasMany($instance->newQuery(), $this, $instance->qualifyColumn($foreignKey), $localKey);
    }
    /**
    ...
    public function morphToMany($related, $name, $table = null, $foreignPivotKey = null, $relatedPivotKey = null, $parentKey = null, $relatedKey = null, $relation = null, $inverse = \false)
    {
        ...
        return $this->newMorphToMany($instance->newQuery(), $this, $name, $table, $foreignPivotKey, $relatedPivotKey, $parentKey ?: $this->getKeyName(), $relatedKey ?: $instance->getKeyName(), $relation, $inverse);
    }
    /**
    ...
    public function morphedByMany($related, $name, $table = null, $foreignPivotKey = null, $relatedPivotKey = null, $parentKey = null, $relatedKey = null, $relation = null)
    {
        ...
        return $this->morphToMany($related, $name, $table, $foreignPivotKey, $relatedPivotKey, $parentKey, $relatedKey, $relation, \true);
    }
    /**
