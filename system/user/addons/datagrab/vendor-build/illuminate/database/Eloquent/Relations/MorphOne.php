...
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Database\Eloquent\SupportsPartialRelations;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\Concerns\CanBeOneOfMany;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\Concerns\ComparesRelatedModels;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\Concerns\SupportsDefaultModels;
...
class MorphOne extends MorphOneOrMany implements SupportsPartialRelations
{
    ...
    public function newRelatedInstanceFor(Model $parent)
    {
        return tap($this->related->newInstance(), function ($instance) use($parent) {
            $instance->setAttribute($this->getForeignKeyName(), $parent->{$this->localKey})->setAttribute($this->getMorphType(), $this->morphClass);
