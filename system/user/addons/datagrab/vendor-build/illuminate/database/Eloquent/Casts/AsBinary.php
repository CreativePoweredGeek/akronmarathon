...
use BoldMinded\DataGrab\Dependency\Illuminate\Support\BinaryCodec;
    ...
    public static function castUsing(array $arguments)
    {
        return new class($arguments) implements CastsAttributes
        {
            ...
            public function __construct(protected array $arguments)
            {
                ...
                if (!\in_array($this->format, BinaryCodec::formats(), \true)) {
                    throw new InvalidArgumentException(\sprintf('Unsupported binary codec format [%s]. Allowed formats are: %s.', $this->format, \implode(', ', BinaryCodec::formats())));
                }
            }
