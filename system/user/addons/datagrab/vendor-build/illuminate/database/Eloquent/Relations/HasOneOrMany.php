...
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Eloquent\Relations\Concerns\SupportsInverseRelations;
    ...
    protected function matchOneOrMany(array $models, EloquentCollection $results, $relation, $type)
    {
        ...
        foreach ($models as $model) {
            ...
            if ($key !== null && isset($dictionary[$key])) {
                ...
                $type === 'one' ? $this->applyInverseRelationToModel($related, $model) : $this->applyInverseRelationToCollection($related, $model);
            }
        }
        return $models;
    }
