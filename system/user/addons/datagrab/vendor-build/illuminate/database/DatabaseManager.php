...
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Connectors\ConnectionFactory;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\Events\ConnectionEstablished;
...
class DatabaseManager implements ConnectionResolverInterface
{
    ...
    public function __construct($app, ConnectionFactory $factory)
    {
        ...
        $this->reconnector = function ($connection) {
            $connection->setPdo($this->reconnect($connection->getNameWithReadWriteType())->getRawPdo());
        };
    }
    /**
    ...
    public function build(array $config)
    {
        ...
        return $this->connectUsing($config['name'], $config, \true);
    }
    /**
