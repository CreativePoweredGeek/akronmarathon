...
namespace BoldMinded\DataGrab\Dependency\Illuminate\Database\Console\Factories;

use BoldMinded\DataGrab\Dependency\Illuminate\Console\GeneratorCommand;
...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    protected function buildClass($name)
    {
        ...
        $namespace = $this->getNamespace(Str::replaceFirst($this->rootNamespace(), 'Database\\Factories\\', $this->qualifyClass($this->getNameInput())));
