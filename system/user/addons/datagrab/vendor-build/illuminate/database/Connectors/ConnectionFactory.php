...
namespace BoldMinded\DataGrab\Dependency\Illuminate\Database\Connectors;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Database\MariaDbConnection;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\MySqlConnection;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\PostgresConnection;
use BoldMinded\DataGrab\Dependency\Illuminate\Database\SQLiteConnection;
...
class ConnectionFactory
{
    ...
    protected function createReadWriteConnection(array $config)
    {
        ...
        return $connection->setReadPdo($this->createReadPdo($config))->setReadPdoConfig($this->getReadConfig($config));
    }
    /**
