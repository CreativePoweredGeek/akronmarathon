...
use Closure;
use Exception;
use BoldMinded\DataGrab\Dependency\Illuminate\Container\Attributes\Bind;
use BoldMinded\DataGrab\Dependency\Illuminate\Container\Attributes\Scoped;
use BoldMinded\DataGrab\Dependency\Illuminate\Container\Attributes\Singleton;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Container\BindingResolutionException;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Container\CircularDependencyException;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Container\SelfBuilding;
...
class Container implements ArrayAccess, ContainerContract
{
    ...
    public function build($concrete)
    {
        ...
        if (\is_null($constructor)) {
            \array_pop($this->buildStack);
            $this->fireAfterResolvingAttributeCallbacks($reflector->getAttributes(), $instance = new $concrete());
            return $instance;
        }
