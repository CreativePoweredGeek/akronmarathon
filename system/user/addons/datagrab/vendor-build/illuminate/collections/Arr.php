...
class Arr
{
    ...
    {
        return \is_array($value) || $value instanceof Arrayable || $value instanceof Traversable || $value instanceof Jsonable || $value instanceof JsonSerializable;
    }
    /**
    ...
    {
        return static::sortRecursive($array, $options, \true);
    }
    /**
