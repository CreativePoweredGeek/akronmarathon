...
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Filesystem\FileNotFoundException;
...
use SplFileObject;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Filesystem\Filesystem as SymfonyFilesystem;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Finder\Finder;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Mime\MimeTypes;
class Filesystem
{
    ...
    {
        return \json_decode($this->get($path, $lock), \true, 512, $flags);
    }
    /**
    ...
    {
        return \iterator_to_array(Finder::create()->files()->ignoreDotFiles(!$hidden)->in($directory)->depth($depth)->sortByName(), \false);
    }
    /**
