...
namespace BoldMinded\DataGrab\Dependency\Illuminate\Events;

use Closure;
use Exception;
use BoldMinded\DataGrab\Dependency\Illuminate\Container\Container;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Container\Container as ContainerContract;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Events\ShouldDispatchAfterCommit;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Events\ShouldHandleEventsAfterCommit;
        ...
        foreach ($this->wildcards as $key => $listeners) {
            if (Str::is($key, $eventName)) {
                foreach ($listeners as $listener) {
                    $wildcards[] = $this->makeListener($listener, \true);
                }
            }
        }
