...
class Sleep
{
     ...
     * @return void
     */
    public static function fake($value = \true, $syncWithCarbon = \false)
    {
        static::$fake = $value;
        static::$sequence = [];
     ...
     * @return void
     */
    public static function syncWithCarbon($value = \true)
    {
