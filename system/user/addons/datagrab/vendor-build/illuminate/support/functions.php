...
use BoldMinded\DataGrab\Dependency\Illuminate\Support\Defer\DeferredCallback;
use BoldMinded\DataGrab\Dependency\Illuminate\Support\Defer\DeferredCallbackCollection;
use BoldMinded\DataGrab\Dependency\Illuminate\Support\Facades\Date;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Process\PhpExecutableFinder;
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\defer')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\php_binary')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\artisan_binary')) {
    /**
...
// Time functions...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\now')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\microseconds')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\milliseconds')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\seconds')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\minutes')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\hours')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\days')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\weeks')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\months')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Illuminate\\Support\\years')) {
    /**
