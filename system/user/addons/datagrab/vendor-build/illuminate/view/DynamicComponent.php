...
use BoldMinded\DataGrab\Dependency\Illuminate\View\Compilers\ComponentTagCompiler;
...
\extract((new \BoldMinded\DataGrab\Dependency\Illuminate\Support\Collection($attributes->getAttributes()))->mapWithKeys(function ($value, $key) {
