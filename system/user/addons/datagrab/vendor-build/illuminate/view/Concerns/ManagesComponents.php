...
namespace BoldMinded\DataGrab\Dependency\Illuminate\View\Concerns;
...
use BoldMinded\DataGrab\Dependency\Illuminate\View\ComponentSlot;
trait ManagesComponents
{
    ...
    {
        $defaultSlot = new ComponentSlot(\trim(\ob_get_clean()));
