...
class WorkerOptions
{
     ...
     * @return void
     */
    public function __construct($name = 'default', $backoff = 0, $memory = 128, $timeout = 60, $sleep = 3, $maxTries = 1, $force = \false, $stopWhenEmpty = \false, $maxJobs = 0, $maxTime = 0, $rest = 0)
    {
        $this->name = $name;
