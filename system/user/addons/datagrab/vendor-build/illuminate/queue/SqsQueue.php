...
use BoldMinded\DataGrab\Dependency\Illuminate\Queue\Jobs\SqsJob;
...
class SqsQueue extends Queue implements QueueContract, ClearableQueue
{
    ...
    {
        return $this->sqs->sendMessage(['QueueUrl' => $this->getQueue($queue), 'MessageBody' => $payload, ...$options])->get('MessageId');
    }
    /**
