...
use BoldMinded\DataGrab\Dependency\Illuminate\Queue\Listener;
use BoldMinded\DataGrab\Dependency\Illuminate\Queue\ListenerOptions;
...
#[\Symfony\Component\Console\Attribute\AsCommand(name: 'queue:listen')]
class ListenCommand extends Command
{
    ...
    protected function gatherOptions()
    {
        ...
        return new ListenerOptions(name: $this->option('name'), environment: $this->option('env'), backoff: $backoff, memory: $this->option('memory'), timeout: $this->option('timeout'), sleep: $this->option('sleep'), rest: $this->option('rest'), maxTries: $this->option('tries'), force: $this->option('force'));
    }
    /**
