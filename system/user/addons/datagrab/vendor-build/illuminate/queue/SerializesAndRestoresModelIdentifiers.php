...
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Database\ModelIdentifier;
...
trait SerializesAndRestoresModelIdentifiers
{
    ...
    {
        return $this->getQueryForModelRestoration((new $value->class())->setConnection($value->connection), $value->id)->useWritePdo()->firstOrFail()->load($value->relations ?? []);
    }
    /**
