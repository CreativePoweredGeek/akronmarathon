...
namespace BoldMinded\DataGrab\Dependency\Illuminate\Queue\Jobs;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Queue\ManuallyFailedException;
use BoldMinded\DataGrab\Dependency\Illuminate\Queue\TimeoutExceededException;
...
abstract class Job
{
     ...
     * @return string
     */
    public abstract function getJobId();
    /**
     * Get the raw body of the job.
     *
     * @return string
     */
    public abstract function getRawBody();
    /**
    ...
    public function fail($e = null)
    {
        ...
        if ($this->shouldRollBackDatabaseTransaction($e)) {
            $this->container->make('db')->connection($this->container['config']['queue.failed.database'])->rollBack(toLevel: 0);
        }
        try {
    ...
    {
        return $e instanceof TimeoutExceededException && $this->container['config']['queue.failed.database'] && \in_array($this->container['config']['queue.failed.driver'], ['database', 'database-uuids']) && $this->container->bound('db');
    }
    /**
