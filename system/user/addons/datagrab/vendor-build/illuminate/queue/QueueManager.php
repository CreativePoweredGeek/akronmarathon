...
use Closure;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Queue\Factory as FactoryContract;
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
    ...
    protected function resolve($name)
    {
        ...
        return $this->getConnector($config['driver'])->connect($config)->setConnectionName($name);
    }
    /**
