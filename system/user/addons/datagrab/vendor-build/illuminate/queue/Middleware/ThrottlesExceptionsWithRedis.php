...
namespace BoldMinded\DataGrab\Dependency\Illuminate\Queue\Middleware;
...
use BoldMinded\DataGrab\Dependency\Illuminate\Redis\Limiters\DurationLimiter;
...
class ThrottlesExceptionsWithRedis extends ThrottlesExceptions
{
    ...
    public function handle($job, $next)
    {
        ...
        $this->limiter = new DurationLimiter($this->redis, $this->getKey($job), $this->maxAttempts, $this->decaySeconds);
