...
use BoldMinded\DataGrab\Dependency\Illuminate\Contracts\Pipeline\Pipeline as PipelineContract;
...
class Pipeline implements PipelineContract
{
    ...
    public function then(Closure $destination)
    {
        ...
        try {
            return $this->withinTransaction !== \false ? $this->getContainer()->make('db')->connection($this->withinTransaction)->transaction(fn() => $pipeline($this->passable)) : $pipeline($this->passable);
        } finally {
            if ($this->finally) {
