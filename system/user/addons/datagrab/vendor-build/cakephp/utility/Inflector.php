 ...
 */
namespace BoldMinded\DataGrab\Dependency\Cake\Utility;
...
class Inflector
{
     ...
     */
    protected static array $_plural = ['/(s)tatus$/i' => '\\1tatuses', '/(quiz)$/i' => '\\1zes', '/^(ox)$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2en', '/([m|l])ouse$/i' => '\\1ice', '/(matr|vert)(ix|ex)$/i' => '\\1ices', '/(x|ch|ss|sh)$/i' => '\\1es', '/([^aeiouy]|qu)y$/i' => '\\1ies', '/(hive)$/i' => '\\1s', '/(chef)$/i' => '\\1s', '/(?:([^f])fe|([lre])f)$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2ves', '/sis$/i' => 'ses', '/([ti])um$/i' => '\\1a', '/(p)erson$/i' => '\\1eople', '/(?<!u)(m)an$/i' => '\\1en', '/(c)hild$/i' => '\\1hildren', '/(buffal|tomat)o$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2oes', '/(alumn|bacill|cact|foc|fung|nucle|radi|stimul|syllab|termin)us$/i' => '\\1i', '/us$/i' => 'uses', '/(alias)$/i' => '\\1es', '/(ax|cris|test)is$/i' => '\\1es', '/s$/' => 's', '/^$/' => '', '/$/' => 's'];
    /**
     * Singular inflector rules
     *
     * @var array<string, string>
     */
    protected static array $_singular = ['/(s)tatuses$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2tatus', '/^(.*)(menu)s$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2', '/(quiz)zes$/i' => '\\1', '/(matr)ices$/i' => '\\1ix', '/(vert|ind)ices$/i' => '\\1ex', '/^(ox)en/i' => '\\1', '/(alias|lens)(es)*$/i' => '\\1', '/(alumn|bacill|cact|foc|fung|nucle|radi|stimul|syllab|termin|viri?)i$/i' => '\\1us', '/([ftw]ax)es/i' => '\\1', '/(cris|ax|test)es$/i' => '\\1is', '/(shoe)s$/i' => '\\1', '/(o)es$/i' => '\\1', '/ouses$/' => 'ouse', '/([^a])uses$/' => '\\1us', '/([m|l])ice$/i' => '\\1ouse', '/(x|ch|ss|sh)es$/i' => '\\1', '/(m)ovies$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2ovie', '/(s)eries$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2eries', '/(s)pecies$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2pecies', '/([^aeiouy]|qu)ies$/i' => '\\1y', '/(tive)s$/i' => '\\1', '/(hive)s$/i' => '\\1', '/(drive)s$/i' => '\\1', '/([le])ves$/i' => '\\1f', '/([^rfoa])ves$/i' => '\\1fe', '/(^analy)ses$/i' => '\\1sis', '/(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2sis', '/([ti])a$/i' => '\\1um', '/(p)eople$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2erson', '/(m)en$/i' => '\\1an', '/(c)hildren$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2hild', '/(n)ews$/i' => 'BoldMinded\\DataGrab\\Dependency\\1\\2ews', '/eaus$/' => 'eau', '/^(.*us)$/' => '\\1', '/s$/i' => ''];
    /**
     * Irregular rules
     *
     * @var array<string, string>
     ...
     * @var array<string>
     */
    protected static array $_uninflected = ['.*[nrlm]ese', '.*data', '.*deer', '.*fish', '.*measles', '.*ois', '.*pox', '.*sheep', 'people', 'feedback', 'stadia', '.*?media', 'chassis', 'clippers', 'debris', 'diabetes', 'equipment', 'gallows', 'graffiti', 'headquarters', 'information', 'innings', 'news', 'nexus', 'pokemon', 'proceedings', 'research', 'sea[- ]bass', 'series', 'species', 'weather'];
    /**
     * Method cache array.
     *
    ...
    public static function pluralize(string $word) : string
    {
        ...
        if (\preg_match(static::$_cache['irregular']['pluralize'], $word, $regs) || \preg_match(static::$_cache['irregular']['upperPluralize'], $word, $regs)) {
    ...
    public static function singularize(string $word) : string
    {
        ...
        if (\preg_match(static::$_cache['irregular']['singular'], $word, $regs) || \preg_match(static::$_cache['irregular']['singularUpper'], $word, $regs)) {
            $suffix = \array_search(\strtolower($regs[2]), static::$_irregular, \true);
