...
use BoldMinded\DataGrab\Dependency\Cake\Event\EventDispatcherInterface;
use BoldMinded\DataGrab\Dependency\Cake\Event\EventListenerInterface;
use Countable;
...
abstract class ObjectRegistry implements Countable, IteratorAggregate
{
     ...
     */
    protected abstract function _resolveClassName(string $class) : ?string;
    /**
     ...
     * @throws \Exception
     */
    protected abstract function _throwMissingClassError(string $class, ?string $plugin) : void;
    /**
     ...
     * @return TObject
     */
    protected abstract function _create(object|string $class, string $alias, array $config) : object;
    /**
