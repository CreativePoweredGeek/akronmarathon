...
use function BoldMinded\DataGrab\Dependency\Cake\Core\deprecationWarning as cakeDeprecationWarning;
use function BoldMinded\DataGrab\Dependency\Cake\Core\env as cakeEnv;
use function BoldMinded\DataGrab\Dependency\Cake\Core\h as cakeH;
use function BoldMinded\DataGrab\Dependency\Cake\Core\namespaceSplit as cakeNamespaceSplit;
use function BoldMinded\DataGrab\Dependency\Cake\Core\pathCombine as cakePathCombine;
use function BoldMinded\DataGrab\Dependency\Cake\Core\pj as cakePj;
use function BoldMinded\DataGrab\Dependency\Cake\Core\pluginSplit as cakePluginSplit;
use function BoldMinded\DataGrab\Dependency\Cake\Core\pr as cakePr;
use function BoldMinded\DataGrab\Dependency\Cake\Core\toBool as cakeToBool;
use function BoldMinded\DataGrab\Dependency\Cake\Core\toFloat as cakeToFloat;
use function BoldMinded\DataGrab\Dependency\Cake\Core\toInt as cakeToInt;
use function BoldMinded\DataGrab\Dependency\Cake\Core\toString as cakeToString;
use function BoldMinded\DataGrab\Dependency\Cake\Core\triggerWarning as cakeTriggerWarning;
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\pathCombine')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\h')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\pluginSplit')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\namespaceSplit')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\pr')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\pj')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\env')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\triggerWarning')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\deprecationWarning')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\toString')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\toInt')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\toFloat')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\toBool')) {
    /**
