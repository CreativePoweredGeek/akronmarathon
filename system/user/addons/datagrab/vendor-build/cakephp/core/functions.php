 ...
 */
namespace BoldMinded\DataGrab\Dependency\Cake\Core;
...
if (!\defined('CAKE_DATE_RFC7231')) {
    \define('CAKE_DATE_RFC7231', 'BoldMinded\\DataGrab\\Dependency\\D, d M Y H:i:s \\G\\M\\T');
}
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\pathCombine')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\h')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\pluginSplit')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\namespaceSplit')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\pr')) {
    /**
    ...
    function pr(mixed $var) : mixed
    {
        ...
        \printf($template, \trim(\print_r($var, \true)));
        return $var;
    }
}
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\pj')) {
    /**
    ...
    function pj(mixed $var) : mixed
    {
        ...
        \printf($template, \trim((string) \json_encode($var, $flags)));
        return $var;
    }
}
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\env')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\triggerWarning')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\deprecationWarning')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\toString')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\toInt')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\toFloat')) {
    /**
...
if (!\function_exists('BoldMinded\\DataGrab\\Dependency\\Cake\\Core\\toBool')) {
    /**
    ...
    {
        if (\in_array($value, ['1', 1, 1.0, \true], \true)) {
            return \true;
        }
        if (\in_array($value, ['0', 0, 0.0, \false], \true)) {
            return \false;
        }
        return null;
    }
