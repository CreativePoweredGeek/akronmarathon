...
use BoldMinded\DataGrab\Dependency\League\Container\Argument\ArgumentReflectorInterface;
use BoldMinded\DataGrab\Dependency\League\Container\Argument\ArgumentReflectorTrait;
...
class ReflectionContainer implements ArgumentReflectorInterface, ArgumentResolverInterface, ContainerInterface
{
    ...
    public const AUTO_WIRING = 0x1;
    public const ATTRIBUTE_RESOLUTION = 0x2;
    protected array $cache = [];
    public function __construct(protected bool $cacheResolutions = \false, protected int $mode = self::AUTO_WIRING | self::ATTRIBUTE_RESOLUTION)
    {
    }
    ...
    {
        if (\true === $this->cacheResolutions && \array_key_exists($id, $this->cache)) {
