...
namespace BoldMinded\DataGrab\Dependency\League\Container\Definition;

use BoldMinded\DataGrab\Dependency\League\Container\Argument\ArgumentResolverInterface;
use BoldMinded\DataGrab\Dependency\League\Container\Argument\ArgumentResolverTrait;
use BoldMinded\DataGrab\Dependency\League\Container\Argument\ArgumentInterface;
use BoldMinded\DataGrab\Dependency\League\Container\Argument\LiteralArgumentInterface;
...
class Definition implements ArgumentResolverInterface, DefinitionInterface
{
    ...
    public function __construct(protected string $id, protected mixed $concrete = null, protected bool $shared = \false, protected array $arguments = [], protected array $methods = [], protected array $tags = [])
    {
        $this->setId($this->id);
