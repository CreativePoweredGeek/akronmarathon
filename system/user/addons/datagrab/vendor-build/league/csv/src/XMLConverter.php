...
use BoldMinded\DataGrab\Dependency\Dom\Element;
use BoldMinded\DataGrab\Dependency\Dom\XMLDocument;
use DOMDocument;
use DOMElement;
use DOMException;
use Exception;
...
class XMLConverter
{
    ...
    private static function newXmlDocument(string $xml_class) : DOMDocument|XMLDocument
    {
        return match (\true) {
            ...
            !in_array($xml_class, [XMLDocument::class, DOMDocument::class], \true) => throw new ValueError('The xml class is invalid.'),
