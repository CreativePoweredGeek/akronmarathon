...
class Statement
{
    protected final const COLUMN_ALL = 0;
    protected final const COLUMN_INCLUDE = 1;
    protected final const COLUMN_EXCLUDE = 2;
     ...
     */
    protected static final function wrapSingleArgumentCallable(callable $where) : callable
    {
     ...
     */
    protected final function appendWhere(string $joiner, Query\Predicate $predicate) : self
    {
        if ([] === $this->where) {
