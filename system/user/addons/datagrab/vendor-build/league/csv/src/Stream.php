...
final class Stream implements SeekableIterator
{
     ...
     */
    private function __construct(private $stream, private readonly bool $is_seekable, private readonly bool $should_close_stream = \false)
    {
    }
    public function __destruct()
    {
        Warning::cloak(\array_walk_recursive(...), $this->filters, static function ($filter) : void {
    ...
    {
        return fputcsv($this->stream, $fields, ...[...$this->filterControl($delimiter, $enclosure, $escape, __METHOD__), $eol]);
    }
    /**
     * Gets line number.
     *
