...
use BoldMinded\DataGrab\Dependency\PHPStan\Reflection\ReflectionProvider;
use BoldMinded\DataGrab\Dependency\PHPStan\Type\ClosureTypeFactory;
...
final class MacroExtension implements MethodsClassReflectionExtension
{
    ...
    public function getMethod(ClassReflection $classReflection, string $methodName) : MethodReflection
    {
        ...
        return new MacroMethodReflection($classReflection, $methodName, $closureType, $static, $final, $deprecated, $docComment);
    }
}
