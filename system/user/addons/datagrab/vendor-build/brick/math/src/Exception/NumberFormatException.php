...
namespace BoldMinded\DataGrab\Dependency\Brick\Math\Exception;
...
final class NumberFormatException extends MathException
{
    ...
    {
        return new self(sprintf('Character %s is not valid in the given alphabet.', self::charToString($char)));
    }
    /**
     * @pure
     */
