...
use BoldMinded\DataGrab\Dependency\Brick\Math\Exception\NumberFormatException;
...
final readonly class BigRational extends BigNumber
{
    ...
    {
        trigger_error('The BigRational::nd() method is deprecated, use BigRational::ofFraction() instead.', E_USER_DEPRECATED);
     ...
     * @pure
     */
    public static function ofFraction(BigNumber|int|float|string $numerator, BigNumber|int|float|string $denominator) : BigRational
    {
    ...
    {
        trigger_error('BigRational::quotient() is deprecated and will be removed in 0.15. Use getIntegralPart() instead.', E_USER_DEPRECATED);
    ...
    {
        trigger_error('BigRational::remainder() is deprecated and will be removed in 0.15. Use `$number->getNumerator()->remainder($number->getDenominator())` instead.', E_USER_DEPRECATED);
    ...
    {
        trigger_error('BigRational::quotientAndRemainder() is deprecated and will be removed in 0.15. Use `$number->getNumerator()->quotientAndRemainder($number->getDenominator())` instead.', E_USER_DEPRECATED);
    ...
    public function compareTo(BigNumber|int|float|string $that) : int
    {
        ...
        return $this->numerator->multipliedBy($that->denominator)->compareTo($that->numerator->multipliedBy($this->denominator));
    }
    #[\Override]
    ...
    public function toFloat() : float
    {
        ...
        return $simplified->numerator->toBigDecimal()->dividedBy($simplified->denominator, $scale, RoundingMode::HalfEven)->toFloat();
    }
    #[\Override]
