 ...
 */
namespace BoldMinded\DataGrab\Dependency\Symfony\Component\Translation\Command;

use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Attribute\AsCommand;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\CI\GithubActionReporter;
...
use BoldMinded\DataGrab\Dependency\Symfony\Component\Translation\Exception\InvalidArgumentException;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Translation\Util\XliffUtils;
/**
 ...
 */
#[\Symfony\Component\Console\Attribute\AsCommand(name: 'lint:xliff', description: 'Lint an XLIFF file and outputs encountered errors')]
class XliffLintCommand extends Command
{
    ...
    public function __construct(?string $name = null, ?callable $directoryIteratorProvider = null, ?callable $isReadableProvider = null, private bool $requireStrictFileNames = \true)
    {
...
EOF
    ...
    private function getFiles(string $fileOrDirectory) : iterable
    {
        ...
        foreach ($this->getDirectoryIterator($fileOrDirectory) as $file) {
            if (!\in_array($file->getExtension(), ['xlf', 'xliff'], \true)) {
                continue;
            }
            (yield $file);
        }
