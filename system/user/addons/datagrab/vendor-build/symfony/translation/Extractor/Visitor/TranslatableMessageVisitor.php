 ...
 */
namespace BoldMinded\DataGrab\Dependency\Symfony\Component\Translation\Extractor\Visitor;

use BoldMinded\DataGrab\Dependency\PhpParser\Node;
...
final class TranslatableMessageVisitor extends AbstractVisitor implements NodeVisitor
{
    ...
    public function leaveNode(Node $node) : ?Node
    {
        ...
        if (!\in_array('TranslatableMessage', $className->getParts(), \true)) {
            return null;
        }
