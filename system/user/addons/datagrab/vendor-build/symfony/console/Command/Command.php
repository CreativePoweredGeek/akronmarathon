 ...
 */
namespace BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Command;

use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Application;
...
use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Helper\HelperInterface;
...
class Command implements SignalableCommandInterface
{
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('BoldMinded\\DataGrab\\Dependency\\setproctitle')) {
