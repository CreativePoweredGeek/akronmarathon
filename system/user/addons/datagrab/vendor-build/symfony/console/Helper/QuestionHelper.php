 ...
 */
namespace BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Helper;

use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Cursor;
use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Exception\MissingInputException;
...
use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Formatter\OutputFormatterStyle;
...
use function BoldMinded\DataGrab\Dependency\Symfony\Component\String\s;
/**
...
class QuestionHelper extends Helper
{
    ...
    private function mostRecentlyEnteredValue(string $entered) : string
    {
        ...
        $lastChoice = \trim(\substr($entered, $lastCommaPos + 1));
    ...
    private function cloneInputStream($inputStream)
    {
        ...
        if (\true === $seekable && !\in_array($mode, ['r', 'rb', 'rt'], \true)) {
