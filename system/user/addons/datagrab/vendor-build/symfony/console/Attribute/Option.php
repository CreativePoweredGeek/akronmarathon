 ...
 */
namespace BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Attribute;

use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Attribute\Reflection\ReflectionMember;
...
use BoldMinded\DataGrab\Dependency\Symfony\Component\Console\Exception\InvalidOptionException;
...
class Option
{
    ...
    public static function tryFrom(\ReflectionParameter|\ReflectionProperty $member) : ?self
    {
        ...
        if (!\in_array($self->typeName, self::ALLOWED_TYPES, \true) && !$isBackedEnum) {
